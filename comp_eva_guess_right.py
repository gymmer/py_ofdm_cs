...
for i in range(gro_num):
    for j in range(P):
        ...
        h_eva,H_eva,bits_eva = receiver(y,W,L,N,Ncp,K,pos_A,'CS','%d'%(j))
...
for i in range(gro_num):
    for j in range(SNR_num):
        ...
        ''' 非法用户 '''
        h_eva_r, H_eva_r,  bits_eva_r  = receiver(y,W,L,N,Ncp,K,pos_E,'CS','from_pos')
        h_eva_2, H_eva_2,  bits_eva_2  = receiver(y,W,L,N,Ncp,K,pos_A,'CS','2')
        h_eva_10,H_eva_10, bits_eva_10 = receiver(y,W,L,N,Ncp,K,pos_A,'CS','10')
        h_eva_20,H_eva_20, bits_eva_20 = receiver(y,W,L,N,Ncp,K,pos_A,'CS','20')
        h_eva_25,H_eva_25, bits_eva_25 = receiver(y,W,L,N,Ncp,K,pos_A,'CS','25')
        h_eva_30,H_eva_30, bits_eva_30 = receiver(y,W,L,N,Ncp,K,pos_A,'CS','30')
        h_eva_35,H_eva_35, bits_eva_35 = receiver(y,W,L,N,Ncp,K,pos_A,'CS','35')
