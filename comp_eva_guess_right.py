...
for i in range(gro_num):
    for j in range(P):
        ...
        h_eva,H_eva,bits_eva = receiver_eva(y,W,N,Ncp,K,pos_A,'%d'%(j))
...
for i in range(gro_num):
    for j in range(SNR_num):
        ...
        ''' 非法用户 '''
        h_eva_r, H_eva_r,  bits_eva_r  = receiver_eva(y,W,N,Ncp,K,pos_E,'from_pos')
        h_eva_2, H_eva_2,  bits_eva_2  = receiver_eva(y,W,N,Ncp,K,pos_A,'2')
        h_eva_10,H_eva_10, bits_eva_10 = receiver_eva(y,W,N,Ncp,K,pos_A,'10')
        h_eva_20,H_eva_20, bits_eva_20 = receiver_eva(y,W,N,Ncp,K,pos_A,'20')
        h_eva_25,H_eva_25, bits_eva_25 = receiver_eva(y,W,N,Ncp,K,pos_A,'25')
        h_eva_30,H_eva_30, bits_eva_30 = receiver_eva(y,W,N,Ncp,K,pos_A,'30')
        h_eva_35,H_eva_35, bits_eva_35 = receiver_eva(y,W,N,Ncp,K,pos_A,'35')
