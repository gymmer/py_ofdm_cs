...
def agreement(P,weight,iteration=2):
    ...
    bits_A_rssi = remain(bits_A_rssi,np.append(drop_listA,drop_listB),drop_listE)
    bits_B_rssi = remain(bits_B_rssi,np.append(drop_listA,drop_listB),drop_listE)
    bits_E_rssi = remain(bits_E_rssi,np.append(drop_listA,drop_listB),drop_listE)
    #print 'BMR of rssi before winnow between AB and AE:',BMR(bits_A_rssi,bits_B_rssi),BMR(bits_A_rssi,bits_E_rssi)
    ...
    ''' winnow信息协调'''
    bits_A_rssi, bits_B_rssi,bits_E_rssi  = winnow(bits_A_rssi, bits_B_rssi, bits_E_rssi, iteration)
    bits_A_phase,bits_B_phase,bits_E_phase = winnow(bits_A_phase,bits_B_phase,bits_E_phase,iteration)
    #print 'BMR of rssi after winnow between AB and AE:',BMR(bits_A_rssi,bits_B_rssi),BMR(bits_A_rssi,bits_E_rssi)
    #print 'BMR of phase after winnow between AB and AE:',BMR(bits_A_phase,bits_B_phase),BMR(bits_A_phase,bits_E_phase)     
