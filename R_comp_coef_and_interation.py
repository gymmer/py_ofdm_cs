...
''' interation为横坐标 '''
plt.figure(figsize=(8,5))
plt.plot(interation,bmr[2,:],'ro-',label='coef=0.2')
plt.plot(interation,bmr[4,:],'yo-',label='coef=0.4')
plt.plot(interation,bmr[6,:],'go-',label='coef=0.6')
plt.plot(interation,bmr[8,:],'bo-',label='coef=0.8')
plt.xlabel('Interation')
plt.ylabel('Bit Mismatch Rate')
plt.title('BMR of different interation(bl=%d)'%(block_size))
plt.legend()

plt.figure(figsize=(8,5))
plt.plot(interation,bgr[2,:],'ro-',label='coef=0.2')
plt.plot(interation,bgr[4,:],'yo-',label='coef=0.4')
plt.plot(interation,bgr[6,:],'go-',label='coef=0.6')
plt.plot(interation,bgr[8,:],'bo-',label='coef=0.8')
plt.xlabel('Interation')
plt.ylabel('Bit Generate Rate')
plt.title('BGR of different interation(bl=%d)'%(block_size))
plt.legend()
plt.ylim(0,1)

plt.figure(figsize=(8,5))
plt.plot(interation,ent[2,:],'ro-',label='coef=0.2')
plt.plot(interation,ent[4,:],'yo-',label='coef=0.4')
plt.plot(interation,ent[6,:],'go-',label='coef=0.6')
plt.plot(interation,ent[8,:],'bo-',label='coef=0.8')
plt.xlabel('Interation')
plt.ylabel('Entropy')
plt.title('Entropy of different interation(bl=%d)'%(block_size))
plt.legend()
plt.ylim(0,1)
