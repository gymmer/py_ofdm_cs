...
lx_MSE  = zeros((gro_num,bl_num))
CS_MSE  = zeros((gro_num,bl_num))
eva_MSE = zeros((gro_num,bl_num))
lx_BER  = zeros((gro_num,bl_num))
CS_BER  = zeros((gro_num,bl_num))
eva_BER = zeros((gro_num,bl_num))
lx_SC   = zeros((gro_num,bl_num))
CS_SC   = zeros((gro_num,bl_num))
